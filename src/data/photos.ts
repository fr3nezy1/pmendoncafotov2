...
export const PHOTOS = {
  ...
  ensaiosHero: UNSPLASH('photo-1516239482977-b550ba7253f2', 1800),
  // TODO: substituir por foto de abertura do contato (Cloudinary)
  contatoHero: UNSPLASH('photo-1476514525535-07fb3b4ae5f1', 1800),
  // Ensaios — Retratos
